...
=item L<MSDN|https://msdn.microsoft.com/en-us/library/ms974570.aspx>

=item L<Regular-Expressions.info|http://www.regular-expressions.info/vbscript.html>
...
=item C<Regexes.globalx> if given will replace all occurrences found, otherwise
only the first one.

=item C<Regexes.ignoreCase> if given will ignore casing while matching.
